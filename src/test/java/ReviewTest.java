...
public class ReviewTest {
  ...
  public void Review_instantiatesCorrectly_true() {
    Review myReview = new Review("great place", "www.google.com/1223433", "5 Stars", 1);
  ...
  public void getRating_returnsRatingCorrectly_true() {
    Review myReview = new Review("great place", "www.google.com/1223433", "5 Stars", 1);
    assertEquals("5 Stars", myReview.getRating());
  }
  ...
  public void equals_returnsTrueIfAttributesAreTheSame_true() {
    Review myReview = new Review("great place", "www.google.com/1223433", "5 Stars", 1);
    Review myReviewTwo = new Review("great place", "www.google.com/1223433", "5 Stars", 1);
